...
//    [self.navigationItem setLeftBarButtonItem:backItem];
    ...
    if (_isSendLocation) {
        ...
        [sendButton setTitleColor:[UIColor appMainColor] forState:UIControlStateNormal];
...
- (void)mapView:(MKMapView *)mapView didFailToLocateUserWithError:(NSError *)error
{
    ...
    [MBProgressHUD errorHudWithView:self.view label:NSLocalizedString(@"location.fail", @"locate failure") hidesAfter:1.0];
    if (error.code == 0) {
...
//    [self showHudInView:self.view hint:NSLocalizedString(@"location.ongoning", @"locating...")];
    [MBProgressHUD hudWithView:self.view label:NSLocalizedString(@"location.ongoning", @"locating...")];
}
